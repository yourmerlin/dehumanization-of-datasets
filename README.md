...
This graph specifically shows the prevalence of landmark_null, which averages around 35-45%. For an organization this large, with the tools and access needed to record this data, such a high rate of missing values is a sign of negligence.
...
Historically and socially, mass surveillance tools have been deployed by police, ICE, and other government agencies to construct their own racial narratives, overcollecting data in certain geographic areas to justify disproportionate enforcement. This overcollection has long been used to criminalize marginalized communities. In her book Automating Inequality: How High-Tech Tools Profile, Police, and Punish the Poor, Virginia Eubanks writes about how many of the devices that collect our information and monitor our actions are inscrutable, invisible pieces of code---embedded in our social media interactions and woven through applications for government services. She examines how low-income and marginalized communities are disproportionately entangled in insurance investigations and burdened with medical debt as a result of algorithmic decision-making, and how these same groups face higher levels of data collection when they access public benefits, walk through heavily policed neighborhoods, enter the healthcare system, or cross national borders. This abundance of data collection is used as a mechanism of control over marginalized communities. So then, wouldn’t the complete absence of data be another tactic of that same control? The government is not limited by the availability of tools, so the mismanagement of data cannot be attributed to a lack of access. It is the result of negligence, purposeful carelessness toward the autonomy of immigrants.

Eubanks centers her framework on the harms of overcollection  but absence operates by an inverse logic. If excess data can criminalize, then missing data can erase. This is where artist and researcher Mimi Onuoha's work becomes relevant. In her Library of Missing Datasets, Onuoha explores data that should exist but does not, arguing that these absences reveal what we collectively "deem important"---exposing hidden social and racial biases through what is left unrecorded. Her inference about why data is missing is one I agree with. But my push for absence goes further: this missing data is not simply a reflection of collective indifference. It is in the hands of an abusive government institution, one with a documented record of negligence that extends into the most basic obligations of human care.

An ACLU report by Hibah Ansari details harrowing testimonies from detainees at the California City Detention Facility, exposing systematic medical neglect and inhumane conditions. Fernando Viera Reyes, who suspects he has prostate cancer, has been repeatedly denied proper diagnostic care and treatment,receiving only vitamin C and suggestions to buy over-the-counter pain relief despite blood in his urine and stool. Another detainee, Fernando Gomez Ruiz, was consistently denied insulin, causing dangerously elevated blood sugar and an untreated foot ulcer. Beyond medical neglect, the facility subjects detainees to frigid temperatures in overcrowded, deteriorating cells---concrete spaces the size of a parking spot---where people resort to wearing socks as makeshift sleeves for warmth. Viera Reyes, who spent over 30 years in prison, stated that conditions at this detention center are worse than prison. These facilities are, in effect, torture chambers: the systematic denial of healthcare, bodily autonomy, and basic dignity constitutes torture both physical and psychological. A government willing to inflict this on people in the most immediate, physical sense, in the room, in the body, cannot be trusted to exercise greater care in what it chooses to record.

These conditions cannot sustain a human being, and the lack of data and secrecy around what actually happens and who is detained only compounds this harm. This physical evidence of neglect, compounded by the deliberate absence of data, points toward something beyond mismanagement. I push for a further idea of missingness, absence, to describe the attempt at the "permanent deletion" of immigrants. To be detained without a documented location, arrested without a recorded method, held without a traceable landmark, is not merely to be uncounted. It is to be made to not exist.
...
Note: I did use claude to help me organize + parse the data. This is just means it took the spreadsheets I organized, and be able to put it into code, instead of me manually copy + pasting. All research and information was done by me :)
